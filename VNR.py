...
logo_image1 = open("VFSG Logo to include on viz - light background.png", "rb").read()

st.image([logo_image,logo_image1], width=300)
...
st.write(banner, unsafe_allow_html=True)
    ...
    tab1, tab2 = st.tabs(["VNR", "GovernanceIndex"])
        ...
        with col1:
            ...
            filteredcountries_subset = filteredcountries_subset.sort_values(by='value', ascending=False)
        ...
        with col2:
            ...
            filteredcountries2_subset = filteredcountries2_subset.sort_values(by='value', ascending=False)
    ...
    if selected_tab == "VNR(Spanish)":
        ...
        with col4:
            ...
            Sfilteredcountries_subset = Sfilteredcountries_subset.sort_values(by='value', ascending=False)
        ...
        # Set the subplot 
            ...
            Sfilteredcountries_subset2 = Sfilteredcountries_subset2.sort_values(by='value', ascending=False)
   ...
   'Country (ESP)': 'country_S',
    ...
    if selected_tab == "Governance Index":
        ...
        with col1:
            ...
            govgrouped_df_col1=gov_counsel_col1.groupby(['country_E','dim_E'])['val'].sum().round(1)
        ...
        with col2:
            ...
            govgrouped_df_col2=gov_counsel_col2.groupby(['country_E','dim_E'])['val'].sum().round(1)
    ...
    if selected_tab == "Índice de Gobernanza":
        ...
        with col4:
            ...
            govgrouped_df_col3=gov_counsel_col3.groupby(['country_S','Dim_S'])['val'].sum().round(1)
        ...
        with col5:
            ...
            govgrouped_df_col4=gov_counsel_col4.groupby(['country_S','Dim_S'])['val'].sum().round(1)
